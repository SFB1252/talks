...
We value your feedback to improve our workshop series. All evaluations are
**internal and anonymous**.

### Post-Workshop Evaluation

[📝 Complete Anonymous Evaluation](https://forms.uni-koeln.de/some-form-link)
(Internal CRC 1252 access only)
...
1. **University staff:** Use your uni.koeln Matrix account
2. **External participants:** Create a Matrix account on any homeserver
3. **Need help?** Check our [Matrix setup guide](docs/matrix-space-setup.md)

### Chat Guidelines

- Open to all SFB 1252 members and workshop participants
- Discussion topics: research methods, data management, workshop feedback, and
  community building
- Respectful and professional communication (with room for fun in Katzentisch!)
- Follow our
  [community guidelines](docs/matrix-space-setup.md#guidelines-for-the-matrix-space)

## Getting Started

New to Project S? Start with our [onboarding materials](onboarding/).

## Schedule

**Current:** [Winter 2025-26 schedule](agenda/winter-2025-26-schedule.md) for
dates and times.

**Previous:** [Summer 2025 schedule](agenda/summer-2025-schedule.md) (archived).

## Contributing

See our [contributing guide](docs/contributing.md) to contribute materials.

## Additional Resources

[Additional resources](resources/additional-links.md) for research support.
