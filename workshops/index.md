...
Introduction to R programming for research applications. Learn data structures,
import/export procedures, basic statistical analysis, and reproducible code
practices.
...
Design and implement online experiments using modern web platforms. Focus on
participant recruitment, data quality control, and ethical considerations.
...
Academic integrity, research ethics, and responsible conduct in research.
Essential foundation for all academic work.
...
Comprehensive approach to organizing, storing, and preserving research data
...
Navigate the ethics approval process for human subjects research. Understanding
IRB requirements and compliance.
...
Master reference management tools and citation techniques for efficient
...
Professional tools for corpus linguistics, text annotation, and linguistic
analysis.
...
Learn to preregister research studies for enhanced transparency and
reproducibility.
...
1. [Good Academic Practice](01-good-academic-practice/) - Research ethics
   foundation
...
1. [Ethics Approval](03-ethics-approval/) - Get approval for human subjects
   research
...
3. [Annotation & Corpus Tools](05-annotation-corpus-tools/) - Advanced text
   analysis
...
- **Preparation**: Recommended readings and setup instructions provided in
  advance
...
**[Winter 2025-26 Schedule](../agenda/winter-2025-26-schedule.html)** -
Registration and dates

### Past Workshops

**[Summer 2025 Archive](../agenda/summer-2025-schedule.html)** - Completed
workshop materials
...
This workshop series is part of **SFB 1252 "Prominence in Language"** research
initiative at the University of Cologne. Our mission is to advance research
methods and provide comprehensive training for the next generation of
researchers.
...
the [current schedule](../agenda/winter-2025-26-schedule.html)._
