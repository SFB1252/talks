...
::: {.callout-note}
If `figures/avm-render.svg` does not appear locally, your TeX installation is likely missing [`langsci-avm`](https://ctan.org/pkg/langsci-avm). Install it (TeX Live Manager: `tlmgr install langsci-avm`) and rerun the build script.
:::
