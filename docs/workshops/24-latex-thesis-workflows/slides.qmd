...
\textcite{burknerBrmsPackageBayesian2017} introduced the brms package
for Bayesian multilevel modelling in R.

% Parenthetical citation — supporting claim:
Bayesian multilevel models can be fitted using Stan via R
\parencite{burknerBrmsPackageBayesian2017}.
