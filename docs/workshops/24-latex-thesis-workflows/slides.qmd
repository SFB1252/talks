...
**Alternative: [`avm`](https://ctan.org/pkg/avm) (legacy style)**

Older papers and templates still use [`avm`](https://ctan.org/pkg/avm), but `langsci-avm` is often easier to read and maintain in modern workflows.
