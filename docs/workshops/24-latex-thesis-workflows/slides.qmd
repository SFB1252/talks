...
% no \addbibresource — use \bibliography{references} at the end of the document
...
::: {.callout-tip}
**APA style:** `style=apa` automatically loads [`biblatex-apa`](https://ctan.org/pkg/biblatex-apa), which implements **APA 7th edition** (2019) and requires `backend=biber`.
:::
