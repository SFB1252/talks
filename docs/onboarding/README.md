...
This onboarding session introduces new members to Project S (Data, Design and
Sustainability) services and resources within SFB 1252 "Prominence in Language".
...
5. Access your files at
   [https://uni-koeln.sciebo.de](https://uni-koeln.sciebo.de/login)

### Additional Resources

- [S_FAQ folder on Sciebo](https://uni-koeln.sciebo.de/s/fvdR9aesnq7O5xu) -
  Frequently asked questions and resources
- [Research Data & Methods Workshop Series](../README.md) - Ongoing workshop
  series
